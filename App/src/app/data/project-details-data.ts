...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    objectives: [
      ...
      '-sécuriser les parcours métier sensibles',
      '-réduire le temps des validations manuelles',
      '-garantir la stabilité globale de l\'application',
      '2-Les principaux risques concernaient :',
