...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    projectId: 'ihm-ged',
    presentation: [
      'La GED (Gestion Electronique des Documents) est un systeme permettant le stockage, la consultation et la modification de documents a travers une base de donnees contenant les documents ainsi que leurs metadonnees : nom du document, client, numero de contrat, type de document, etc.',
      'Le projet GED Access est ne dans le cadre du rapprochement entre les societes Mutex et Harmonie Mutuelle, durant une phase de transition entre leurs deux systemes d information.',
      'L objectif etait de permettre aux utilisateurs d acceder aux documents des deux GED existantes (Mutex et HM) a travers une nouvelle interface unifiee et de nouvelles API capables d interroger les deux environnements.',
      'Le projet se divisait en deux parties : adaptation de l IHM GED cote Harmonie Mutuelle pour consommer les nouvelles API, et remplacement de l IHM GED Mutex par une nouvelle interface permettant l acces aux documents Mutex et HM.',
      'Ma mission portait principalement sur la qualite logicielle : automatiser les tests de la nouvelle IHM et des API afin de garantir la fiabilite des fonctionnalites avant mise en production.',
    ],
    objectives: [
      'Assurer la qualite et la stabilite du nouveau systeme GED dans un contexte sensible de fusion entre deux SI critiques.',
      'Permettre la recherche de documents, la consultation des documents, la modification des metadonnees, l acces aux documents des deux GED, et la fiabilite des echanges entre IHM et API.',
      'Enjeux : garantir la continuite metier pendant la transition SI.',
      'Enjeux : eviter les regressions sur des fonctionnalites sensibles.',
      'Enjeux : securiser les echanges entre les deux systemes.',
      ...
      'Risques : regressions sur l interface utilisateur.',
      'Risques : impacts metier en cas d erreur sur les documents contractuels.',
      'Dans ce contexte, l automatisation des tests etait essentielle.',
    ],
    actions: [
      'Creation complete du projet de tests automatises Selenium depuis zero.',
      'Mise en place de la structure globale du projet, de l organisation des packages, des methodes de base, de la configuration des drivers et du pattern Page Object Model.',
      'Preparation des jeux de donnees de test pour disposer d une base propre, maintenable et reutilisable.',
      'Developpement des tests front Selenium pour valider la recherche de documents, l affichage des resultats, la consultation des fiches documentaires, la modification des informations, les parcours critiques et la non-regression.',
      'Conception des tests back avec Postman pour verifier les endpoints de recherche, les reponses API, la coherence des donnees retournees, les cas d erreur, les validations metier et certaines performances de reponse.',
      'Standardisation des controles via des collections Postman pour faciliter les campagnes de validation.',
    ],
    actors:
      'Projet en contexte reel d entreprise avec developpeurs frontend, developpeurs backend, equipes metier GED, equipes QA, responsables techniques et utilisateurs finaux cote Mutex et Harmonie Mutuelle. Les interactions portaient sur la comprehension des parcours metier, l identification des scenarios critiques, la validation des cas de tests, l analyse des anomalies detectees et le suivi des corrections avant livraison. Mon role necessitait une collaboration reguliere avec les equipes techniques et metier pour garantir la pertinence des tests.',
    results: [
      'Base de projet Selenium propre et reutilisable.',
      ...
      'Amelioration de la qualite des livraisons.',
      'Renforcement des competences en assurance qualite, automatisation de tests et comprehension des systemes complexes en environnement metier sensible.',
      'Developpement d une meilleure vision de la relation entre qualite logicielle et continuite metier.',
    ],
    aftermath: [
      'Enrichir la couverture des tests automatises.',
      'Integrer davantage de tests de performance.',
      'Ameliorer le reporting des campagnes de tests.',
      'Connecter les resultats aux outils de suivi qualite.',
      'Integrer les tests dans une vraie chaine CI/CD complete.',
      'Renforcer les tests sur les echanges inter-systemes.',
      'Aujourd hui, cette base de tests reste un socle solide pour accompagner l evolution du projet GED.',
    ],
    criticalView:
      'Je me donnerais une note de 8/10. Le principal point fort a ete la mise en place complete du framework de tests automatises a partir de zero, ce qui demandait a la fois de la rigueur technique et une bonne comprehension metier. Le plus difficile etait de tester un projet fortement dependant de plusieurs systemes existants et de nombreux cas metiers sensibles. Avec plus de temps, j aurais pousse davantage l industrialisation des tests avec une integration plus complete dans une chaine CI/CD. Ce projet m a surtout appris que la qualite logicielle ne repose pas uniquement sur les tests eux-memes, mais sur la capacite a anticiper les risques metier reels.',
  },
  {
    projectId: 'octopus',
    presentation: [
