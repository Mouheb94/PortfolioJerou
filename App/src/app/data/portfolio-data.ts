...
export const projects : Project[] = [
  ...
  },
  {
    ...
    shortDesc : {
      fr : 'Automatisation des tests front-end avec Selenium, mise en place et maintenance d\'une TNR complète (1246 cas de test) et participation aux campagnes de validation mensuelles (TNR + tests de référence) pour sécuriser les mises en production.',
    },
    fullDesc : {
      fr : 'Projet réalisé sur une application métier critique de Mutex. Rôle centré sur l\'automatisation des tests Selenium, la maintenance d\'une suite de 1246 cas, la conduite des campagnes de validation mensuelles et la sécurisation continue des mises en production.',
    },
